<?php 
  ...
  // redirect to index.php if user has not submitted index's form
  if(
    !isset($_GET["user-role"]) || 
      
        !(strtolower($_GET["user-role"]) == "employee" ||
        strtolower($_GET["user-role"]) == "client")
...
<body>
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
      <a class="navbar-brand" href="../public/">Car Workshop</a>
